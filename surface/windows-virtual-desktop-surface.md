...
description: Questo articolo spiega come i dispositivi Surface offrono un nodo finale ideale per le soluzioni Desktop virtuale di Azure, offrendo ai clienti fattori di forma flessibili, sicurezza e gestibilità dei dispositivi moderni Windows 10 e supporto per scenari di lavoro & tempo reale e su richiesta.
ms.prod: w10
...
- **Windows Update.** Mantenere Windows aggiornato consente di essere sempre al passo con le nuove minacce alla sicurezza. Windows 10 è stato progettato da zero per essere più sicuro e utilizzare le funzionalità hardware più recenti per migliorare la sicurezza. Con un aggiornamento UEFI <a href="#5"><sup>5</sup></a> e Windows business appositamente creato che risponde alle minacce in continua evoluzione, la protezione end-to-end è sicura e semplificata.
...
- **Unità rimovibili.** Un sottoinsieme di dispositivi Surface più recente offre unità SSD <a href="#6"><sup>rimovibili 6</sup></a> che offrono un maggiore controllo sulla conservazione dei dati.
...
<a id="1">1.</a> Desktop virtuale di Azure in Surface si riferisce all'esecuzione di Azure Virtual Desktop Infrastructure su un dispositivo Surface ed è descritto qui come una soluzione architetturale, non un prodotto disponibile separatamente.<br>
...
<a id="7">7.</a> DFCI è attualmente disponibile per Surface Laptop edizione Standard, Surface Laptop Studio, Surface Pro 8, Surface Go 3, Surface Laptop 4, Surface Laptop Go, Surface Book 3, Surface Laptop 3, Surface Pro 7+, Surface Pro 7 e Surface Pro X. [Altre informazioni sulla](surface-manage-dfci-guide.md) gestione delle impostazioni UEFI di Surface.
