...
##  <a name="updating-surface-device-drivers-and-firmware"></a>Aggiornamento di driver e firmware per dispositivi Surface
...
##  <a name="surface-ethernet-adapters-and-configuration-manager-deployment"></a>Distribuzione di adapter Ethernet Surface e gestione configurazione
...
##  <a name="use-prestaged-media-with-surface-clients"></a>Usare elementi multimediali preallestiti con client Surface
...
##  <a name="licensing-conflicts-with-oem-activation-3.0"></a>Conflitti di licenza con l'attivazione OEM 3,0
...
##  <a name="configure-push-button-reset"></a>Configurare il pulsante Reimposta
